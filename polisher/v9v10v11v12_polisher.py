...
from v3v4v5v6v7v8v9v10v11v12_roko_data_module import RokoDataModule
#import sys
...
class GRUNetwork(nn.Module):
    ...
    def forward(self, pos_stat: torch.Tensor) -> torch.Tensor:
        pos_stat = F.relu(self.linear(pos_stat)) # B S P
...
class Polisher(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        reads = reads.long() # x = B R S, y = B S
        labels = labels.long()
        pos_stat = pos_stat.transpose(1,2).float() # B S F
